        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-1">
            {navLinks.map((link) =>
              link.hasDropdown ? (
                ...
                >
                  <button className="flex items-center gap-1 px-4 py-2 text-white/80 hover:text-white text-sm font-medium rounded-lg hover:bg-white/5 transition-all duration-300">
                    {link.name}
                    <ChevronDown
                      size={14}
                ...
                <Link
                  key={link.name}
                  href={link.href}
                  className="px-4 py-2 text-white/80 hover:text-white text-sm font-medium rounded-lg hover:bg-white/5 transition-all duration-300"
                >
                  {link.name}
                </Link>
              )
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="w-10 h-10 flex items-center justify-center bg-white/5 border border-white/10 text-white/70 rounded-full hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105 active:scale-95 group"
              title="Call Us"
            >
            ...
            <Link
              href="/contact"
              className="btn-glass inline-flex items-center gap-2 text-sm px-5 py-2.5 text-white font-semibold rounded-full hover:border-accent/40 hover:shadow-accent/10 transition-all duration-300 hover:scale-105 active:scale-95"
            >
              <Calendar size={14} />
              Book a Consultation
            </Link>

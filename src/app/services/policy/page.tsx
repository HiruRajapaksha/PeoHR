        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gold/10 border border-gold/20 rounded-full mb-4">
              <span className="text-gold text-sm font-medium">HR Policy Development</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {deliverables.map((d) => (
              <div key={d} className="glass-card p-5 border border-white/5 hover:border-gold/20 transition-all">

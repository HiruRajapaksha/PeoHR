        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-secondary/10 border border-secondary/20 rounded-full mb-4">
              <span className="text-secondary-light text-sm font-medium">Training & Development</span>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {programs.map((p) => (
              <div key={p} className="glass-card p-5 border border-white/5 hover:border-secondary/20 transition-all">
